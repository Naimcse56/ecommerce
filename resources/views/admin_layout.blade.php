...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<a class="brand" href="#"><span>E-Shopper</span></a>
			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="{{URL::to('/addBrand')}}"><i class="icon-dashboard"></i><span class="hidden-tablet"> Add Brands</span></a></li>
						...
						<li>
							...
							<ul>
								...
								<li><a class="submenu" href="{{URL::to('/allProduct')}}"><i class="icon-file-alt"></i><span class="hidden-tablet"> All Product</span></a></li>
							</ul>	
						</li>
						<li><a class="dropmenu" href="#"><i class="icon-edit"></i><span class="hidden-tablet"> Sliders</span></a>
						<ul>
	...
	<footer>
		...
		<p>
			<span style="text-align:left;float:left">&copy; 2018 <a href="#">Admin Dashboard</a></span>
